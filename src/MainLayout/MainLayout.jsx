...
function MainLayout({ children }) {
    ...
    const sectionIds = ['section1', 'section2', 'section3', 'section4']; // Asegúrate de tener estas secciones en tu contenido
    ...
    return (
        <div className='flex h-screen bg-gray-100'>
            ...
            <div className='flex flex-col flex-1 overflow-y-auto'>
                ...
                {/* Main content area */}
                <div ref={sectionsRef} className='main-layout h-screen overflow-y-auto'>
                    {children}
                    <Outlet />
                </div>
            </div>
